...
// Pastikan KelasID ada dalam URL
...
// Ambil data tugas berdasarkan KelasID
                ...
                <div class="flex flex-col gap-[30px] mt-2">
                    ...
                    <div class="question-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                        ...
                        <div class="flex items-center gap-[14px]">
                            <a href="ipknilai.php?TugasID=<?php echo $row['TugasID']?>" class="bg-[#0A090B] p-[14px_30px] rounded-full text-white font-semibold">Lihat Nilai</a>
                        </div>
                    </div>
                </div>
                <?php endwhile; ?>
